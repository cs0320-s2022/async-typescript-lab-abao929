...
sun.addEventListener("change", function (event) { return postAndUpdate(); });
moon.addEventListener("change", function (event) { return postAndUpdate(); });
rising.addEventListener("change", function (event) { return postAndUpdate(); });
...
function postAndUpdate() {
    ...
    }).then(function (response) { return response.json(); }).then(function (data) { return updateSuggestions(data["matches"]); });
...
function updateSuggestions(matches) {
    ...
    matches.forEach(function (value) { return suggestions.innerHTML += "<li tabindex=\"0\">".concat(value, "</li>"); });
}
...
document.addEventListener("keyup", function (event) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(event.key == 'a')) return [3 /*break*/, 2];
                return [4 /*yield*/, updateValues("Taurus", "Gemini", "Cancer")];
            case 1:
                _a.sent();
                postAndUpdate();
                _a.label = 2;
